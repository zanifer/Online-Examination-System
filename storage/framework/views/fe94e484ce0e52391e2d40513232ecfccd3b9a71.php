<?php /* C:\xampp\htdocs\Final_auth\resources\views/admin_add_ques.blade.php */ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <a href="admin">Manage User</a>
  <a href="admin_add_ques">Add Ques</a>
  <a href="#contact">Remove Ques</a>
  ...
  <form class="form-horizontal" action="<?php echo e(route('store')); ?>" method="post">
    ...
    <div class="col-sm-10">
      <input type="question" class="form-control" id="question" placeholder=" Enter question no">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="question" class="form-control" id="question" placeholder=" Enter question">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-xs-2">
      <input type="option " class="form-control" id="option a" placeholder="Enter option a">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-xs-2">
      <input type="option " class="form-control" id="option b" placeholder="Enter option b">
    </div>
  </div> 
   ...
   <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="option " class="form-control" id="option c" placeholder="Enter option c">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="option " class="form-control" id="option d" placeholder="Enter option d">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="option " class="form-control" id="answer" placeholder="Select answer">
    </div>
  </div>
