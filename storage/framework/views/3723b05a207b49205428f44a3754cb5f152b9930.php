<?php /* C:\xampp\htdocs\Final_auth\resources\views/questionList.blade.php */ ?>
     <!DOCTYPE html>
  <html>
  <head>
    <meta charset="utf-8">
...
<div class="header">  
  <div class="row">
     ...
     <tr class="success">
       ...
       <td>
         <a href="<?php echo e(route('question_edit', $question->id)); ?>" class="btn btn-success">Edit</a>  

       </td>
       <td>
        <form class="form-inline" action="<?php echo e(route('delete', $question->id)); ?>" method="post">
