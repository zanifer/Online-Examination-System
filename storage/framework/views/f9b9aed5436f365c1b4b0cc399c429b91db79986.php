<?php /* C:\xampp\htdocs\Final_auth\resources\views/admin_manage.blade.php */ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="container">
   <table class="table table-condensed table-bordered table-hover">
     ...
     <tr class="success">
       ...
       <td>
         <a href="<?php echo e(route('edit', $user->id)); ?>" class="btn btn-success">Edit</a>  

       </td>
       <td>
        <form class="form-inline" action="<?php echo e(route('delete', $user->id)); ?>" method="post">
