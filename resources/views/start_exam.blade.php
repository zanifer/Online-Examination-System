...
<body>
  ...
  <a href="{{ route('start_exam') }}"> Start Exam</a>
...
@foreach($question as $question)
 ...
 <p class="lead">({{$i}}) {{$question->question}} </p>
  ...
  <div class="container">
    <p><strong>(a){{$question->option_a}}</strong></p>
    <p><strong>(b){{$question->option_b}}</strong></p>
    <p><strong>(c){{$question->option_c}}</strong></p>
    <p><strong>(d){{$question->option_d}}</strong></p>
  ...
  <form method="get" action="{{route('count')}}">
   ...
   <label class="control-label col-sm-2" for="q1">Question 1:</label>
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken1" class="form-control"  value="@php echo $array[1]; @endphp"  >
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden"  name="taken2" class="form-control"  value="@php echo $array[2]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken3" class="form-control "value="@php echo $array[3]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken4" class="form-control" value="@php echo $array[4]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken5" class="form-control" value="@php echo $array[5]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken6" class="form-control" value="@php echo $array[6]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken7" class="form-control" value="@php echo $array[7]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken8" class="form-control" value="@php echo $array[8]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken9" class="form-control" value="@php echo $array[9]; @endphp">
    </div>
    ...
    <div class="col-sm-2">
      ...
      <input type="hidden" name="taken10" class="form-control" value="@php echo $array[10]; @endphp">
    </div>
